...
if (Meteor.isServer) {
  ...
  Emitter.on(Event.CREATE_GROUP, function (user, group) {
    GroupTimelineItems.insert({groupId: group._id, type: "createGroup", datetime: group.foundedDate, userId: user._id});
  });
}
